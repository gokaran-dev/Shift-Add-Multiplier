...
HD_PWD='D:/Mtech/Vivado/multipliers/multipliers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Shift_multipliers.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Shift_multipliers.tcl
